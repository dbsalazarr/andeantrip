...
<div class="contenedor-principal">
	...
	<div class="content-header-hero-tour" style="background: linear-gradient(180deg, rgba(0, 0, 0, .6), rgba(0, 0, 0, .6) ), url(<?php echo get_template_directory_uri(); ?>/media/machupicchu-tour.jpg) center center;">
