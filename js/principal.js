...
function menuFunctionality(){
	...
	bar.addEventListener("click", () => {
		if (contentMenu.classList.contains("active")){
			...
			imagenLogo.setAttribute("src", "http://www.andeantripmachupicchu.com/wp-content/themes/andean/media/brand-andean-blank.png")
		}
		else {
			contentMenu.classList.add("active")
			cabecera.classList.add("active")
			imagenLogo.setAttribute("src", "http://www.andeantripmachupicchu.com/wp-content/themes/andean/media/brand-andean-color.png")
		}
	})
}
